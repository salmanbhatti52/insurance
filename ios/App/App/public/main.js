...
const routes = [
    ...
    {
        path: 'transreceipt',
        loadChildren: () => __webpack_require__.e(/*! import() */ "src_app_transreceipt_transreceipt_module_ts").then(__webpack_require__.bind(__webpack_require__, /*! ./transreceipt/transreceipt.module */ 358)).then(m => m.TransreceiptPageModule)
    }
];
