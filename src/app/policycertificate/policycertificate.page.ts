...
@Component({
  selector: 'app-policycertificate',
  templateUrl: './policycertificate.page.html',
  styleUrls: ['./policycertificate.page.scss'],
})
export class PolicycertificatePage implements OnInit {
